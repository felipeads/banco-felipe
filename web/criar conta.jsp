	...
	<div id="content" class="container_16 clearfix">
		<div class="grid_11">
			<h2>Criação de conta</h2>
			 <form method="Post" action="CriarContaServlet">
				Cpf: <input type="text" name="cpf" placeholder="Ex:999.999.999-99" required pattern=" [0-9]{3}.[0-9]{3}.[0-9]{3}-[0-9]{2}
pattern " >
				<c:if test="${not empty message}">
					<p style="font-weight: normal; color: blueviolet;">${message}</p>	
				</c:if><br /> 
				Nome: <input type="text" name="nome" placeholder="Ex: Felipe"> 
				<c:if test="${not empty message}">
					<p style="font-weight: normal; color: blueviolet;">${message}</p>	
				</c:if>
				<br /> 
